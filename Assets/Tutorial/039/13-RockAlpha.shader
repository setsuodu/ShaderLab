...
#pragma fragment frag
			...
			fixed4 frag(v2f f):SV_Target {
				...
				fixed4 texColor = tex2D(_MainTex, f.uv.xy) * _Color.rgba;
				...
				//return fixed4(tempColor, 0.5); //直接赋值
				//return fixed4(tempColor, _Color.a); //颜色中取值
				return fixed4(tempColor, texColor.a); //贴图中取值
			}
